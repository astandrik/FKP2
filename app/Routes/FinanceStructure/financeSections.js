...
var entity = {
  ...
  resolve:{
    financeSections: function section($http, $stateParams, $financeFactory,$projectsDict) {
      ...
      return $financeFactory.getListFilter({section_id: section_id, to: to, from: from}).then(function (data) {
        helpers.appendHrefs(data, 'home.financeStructure.sections', $projectsDict,section_id);
